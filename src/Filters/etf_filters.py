...
if __name__ == '__main__':
    ...
    for date in DATE_ARRAY:
        ...
        mst_filter(filename, start_date=date, end_date=VOLUME_END_DATE, target_name=target_name, ticker_type='etf', min_sr=False)
        mst_filter(filename, start_date=date, end_date=VOLUME_END_DATE, target_name=target_name, ticker_type='etf', min_sr=True, sr_value=0)
        mst_filter(filename, start_date=date, end_date=VOLUME_END_DATE, target_name=target_name, ticker_type='etf', min_sr=True, sr_value=1)
