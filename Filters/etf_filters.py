...
DATE_ARRAY = ['2020-05-01', '2019-05-01', '2018-05-01', '2017-05-01']
...
if __name__ == '__main__':
    ...
    # volume_filter(ETF_ER_FILTERED_TICKERS, VOLUME_START_DATE, VOLUME_END_DATE, MINIMUM_VOLUME_2021, 'etf')


    for date in DATE_ARRAY:
        date_filter(ETF_VOLUME_FILTERED_FILENAME, start_date=date, ticker_type='etf', target_name=date.split('-', maxsplit=1)[0])
